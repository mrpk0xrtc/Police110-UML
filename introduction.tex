...
\vspace{1cm}
با افزایش حجم داده ها, مدارک, تجهیزات و پرسنل پایگاه های پلیس, نیاز به یک پایگاه داده و نرم افزار مدیریتی احساس می شود. در سیستم جاری (نرم افزار مدیریت پلیس 110) سعی بر آن شده که با روش تحلیل بررسی سیستم با دید نرم افزاری پرداخته شود.

\vspace{3cm}
\begin{latin}
\noindent Email: \href{mailto:mr.pk0xrtc@gmail.com}{mr.pk0xrtc@gmail.com}
\newline
Github: \href{https://github.com/mrpk0xrtc/Police110-UML}{https://github.com/mrpk0xrtc/Police110-UML}
\end{latin}
\vspace{2cm}
